                ...
                <div class="pb-4 bg-white dark:bg-gray-900">
                    <div
                        ...
                        <div class="inline-flex rounded-md shadow-xs justify-end" role="group">
                            <a href="/chat"><button type="button"
    ...
    methods: {
        getChats: async function () {
            await axios({
                ...
                .then((response) => {
                    this.pagination.total = response.data.chats.total;
                    this.pagination.per_page = response.data.chats.per_page;
                    this.pagination.page = response.data.chats.current_page;

                    this.chats = response.data.chats.data;
                });
        },
