    ...
    <AuthenticatedLayout>
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="bg-gray-100 h-screen flex flex-col max-w-lg mx-auto">
                ...
                <div class="flex-1 overflow-y-auto p-4">
                    <div class="flex flex-col space-y-2">
                        <div v-for="(chatMessage, index) in chatMessages" :key="index">
                            <div class="flex" :class="{ 'justify-end': chatMessage.is_by_user }">
                ...
                <div v-if="chat.is_open" class="bg-white p-4 flex items-center">
                    ...
                    <button @click="storeMessage" :disabled="!message || submitting" class="bg-blue-500 text-white rounded-full p-2 ml-2 hover:bg-blue-600 focus:outline-none">
