            ...
            <div
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <form>
                        ...
                        <button :disabled="!name || !content || submitting" @click="storeInstruction" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                    </form>
...
export default {
    ...
    methods: {
        storeInstruction: async function () {
            ...
            await axios({
                ...
                url: "/async/store-instruction",
            }).then((response) => {
                window.location = '/bot/' + this.bot.id;
                this.$toast.success('New instruction created.');
            }).catch((error) => {
