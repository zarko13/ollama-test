                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="(instruction , index) in instructions" :key="index"
                                ...
                                <td class="px-6 py-4">
                                    <button @click="deleteInstruction(instruction)" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Delete</button>
                                </td>
                            </tr>
                            ...
                            <tr v-for="(document , i) in documents" :key="i"
                                ...
                                <td class="px-6 py-4">
                                    <a target="_blank" :href="document.display_path">
                                        <a :href="'/download-document/' + document.id ">
...
export default {
    ...
    methods: {
        deleteInstruction: async function (instruction) {
            await axios({
                method: "POST",
                data: {
                    reference : instruction.id
                },
                url: "/async/delete-instruction",
            }).then((response) => {
